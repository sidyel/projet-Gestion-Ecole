...
/**
 * Home object for domain model class AssoClasseCours.
 * 
 * @see entite.AssoClasseCours
 * @author Hibernate Tools
 */
public class AssoClasseCoursHome {

	private static final Log log = LogFactory.getLog(AssoClasseCoursHome.class);
	private static final SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
	/*
	 * @PersistenceContext private EntityManager entityManager;
	 */

	public void persist(AssoClasseCours transientInstance) {
	...
	public void remove(AssoClasseCours persistentInstance) {
	...
	public void merge(AssoClasseCours detachedInstance) {
	...
	public AssoClasseCours findById(int id) {
		log.debug("Recherche de l'instance Utilisateur avec l'identifiant: " + id);
		try {
			Session ss = sessionFactory.openSession();
			Transaction tx = ss.beginTransaction();
			AssoClasseCours utilisateur = ss.get(AssoClasseCours.class, id);
