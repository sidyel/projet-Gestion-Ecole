...
/**
 * Home object for domain model class ActiviteExtra.
 * @see entite.ActiviteExtra
 * @author Hibernate Tools
 */

public class ActiviteExtraHome {

	private static final Log log = LogFactory.getLog(ActiviteExtraHome.class);
	...
	public void persist(ActiviteExtra transientInstance) {
	...
	public void remove(ActiviteExtra persistentInstance) {
	...
	public void merge(ActiviteExtra detachedInstance) {
	...
	public ActiviteExtra findById(int id) {
	    log.debug("Recherche de l'instance Utilisateur avec l'identifiant: " + id);
	    try {Session ss=sessionFactory.openSession();
		Transaction tx=ss.beginTransaction();
		ActiviteExtra utilisateur = ss.get(ActiviteExtra.class, id);
