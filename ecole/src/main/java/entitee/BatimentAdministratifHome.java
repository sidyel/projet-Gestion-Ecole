...
/**
 * Home object for domain model class BatimentAdministratif.
 * 
 * @see entite.BatimentAdministratif
 * @author Hibernate Tools
 */
public class BatimentAdministratifHome {

	private static final Log log = LogFactory.getLog(BatimentAdministratifHome.class);
	private static final SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
	/*
	 * @PersistenceContext private EntityManager entityManager;
	 */

	public void persist(BatimentAdministratif transientInstance) {
	...
	public void remove(BatimentAdministratif persistentInstance) {
	...
	public void merge(BatimentAdministratif detachedInstance) {
	...
	public BatimentAdministratif findById(int id) {
		log.debug("Recherche de l'instance Utilisateur avec l'identifiant: " + id);
		try {
			Session ss = sessionFactory.openSession();
			Transaction tx = ss.beginTransaction();
			BatimentAdministratif utilisateur = ss.get(BatimentAdministratif.class, id);
