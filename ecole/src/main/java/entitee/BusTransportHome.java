...
/**
 * Home object for domain model class BusTransport.
 * 
 * @see entite.BusTransport
 * @author Hibernate Tools
 */
public class BusTransportHome {

	private static final Log log = LogFactory.getLog(BusTransportHome.class);
	private static final SessionFactory sessionFactory = HibernateUtil.getSessionFactory();
	/*
	 * @PersistenceContext private EntityManager entityManager;
	 */

	public void persist(BusTransport transientInstance) {
	...
	public void remove(BusTransport persistentInstance) {
	...
	public void merge(BusTransport detachedInstance) {
	...
	public BusTransport findById(int id) {
		log.debug("Recherche de l'instance Utilisateur avec l'identifiant: " + id);
		try {
			Session ss = sessionFactory.openSession();
			Transaction tx = ss.beginTransaction();
			BusTransport utilisateur = ss.get(BusTransport.class, id);
